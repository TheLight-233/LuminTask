...
public readonly unsafe partial struct LuminTask
{
    ...
    public static LuminTask CanceledTask()
    {
        ...
        return new LuminTask(CanceledResultSource<AsyncUnit>.MethodTablePtr,
            source , source->Id);
    }

    [DebuggerHidden]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static LuminTask FromResult() => new();
    ...
    public static LuminTask FromException(Exception ex)
    {
        ...
        return new LuminTask(ExceptionResultSource<AsyncUnit>.MethodTablePtr, source, source->Id);
    }
    ...
    public static LuminTask<T> FromException<T>(Exception ex)
    {
        ...
        return new LuminTask<T>(ExceptionResultSource<T>.MethodTablePtr, source, source->Id);
    }
    ...
    public static LuminTask FromCanceled(CancellationToken cancellationToken = default)
    {
        ...
        else
        {
            ...
            return new LuminTask(CanceledResultSource<AsyncUnit>.MethodTablePtr, source , source->Id);
        }
    }
    ...
    public static LuminTask<T> FromCanceled<T>(CancellationToken cancellationToken = default)
    {
        ...
        return new LuminTask<T>(CanceledResultSource<T>.MethodTablePtr, source , source->Id);
    }
    ...
    public static LuminTask Never(CancellationToken cancellationToken)
    {
        ...
        return new LuminTask(NeverPromise<AsyncUnit>.MethodTablePtr, source , source->Id);
    }
    ...
    public static LuminTask<T> Never<T>(CancellationToken cancellationToken)
    {
        ...
        return new LuminTask<T>(NeverPromise<T>.MethodTablePtr, source , source->Id);
    }
